...
import com.lexisnexis.risk.swqa.RIN.ui.pages.Sexoffence;
...
public class CR_Sex_TEST extends BaseTest {
    ...
    @Test(dataProvider="Authentication")
      public void Comp_report(String Browser,String username,String	password,String	name,String	LexID,String ssn,String	Header1,String	Header2,String	Header3,String	Header4,
    		  String Name,String DateLastSeen,String 	ConvictionDate,String 	StateofOrigin,String 	D_Name,String 	D_NameVal,String 	D_Address,String 	D_AddressVal,String D_LexID,
    		  String D_LexIDVal,String 	D_SSN,String 	D_SSNVal,String 	D_DOB,String 	D_DOBVal,String 	D_HairColor,String 	D_HairColorVal,String 	D_EyeColor,String 	D_EyeColorVal,
    		  String D_Height,String 	D_HeightVal,String 	D_Weight,String 	D_WeightVal,String 	D_Race,String 	D_RaceVal,String 	D_OffenderID,String  D_OffenderIDVal,String  D_StateofOrigin,
    		 String D_StateofOriginVal) throws Throwable {
    	    	
    	 test=extent.createTest("Comp Report Sexual Offence");
        ...
        Sexoffence obj5= PageFactory.initElements(driver, com.lexisnexis.risk.swqa.RIN.ui.pages.Sexoffence.class);
	...
	System.out.println(selectall);
		...
		obj4.sexoffence.click();
	    obj4.Requestreport.click();
	    obj5 =new Sexoffence(driver);
	    Thread.sleep(10000);
	    Boolean container =obj5.Container.isDisplayed();
		System.out.println("Sex Offence Container present is " +container);
		Assert.assertTrue(container);
		  test.log(Status.PASS, "Sex Offence container present");
		Thread.sleep(10000);
		
		String SO =driver.findElement(By.xpath("//*[@id=\"grid-container\"]/gridster-item[2]/app-widget-container/div/div[1]/div[1]/span")).getText();
		System.out.println(SO);
		int s1=SO.length();
		System.out.println(s1);
	/*	String num= SO.substring(16,s1-1);
    ...
    public Object[][] Authentication() throws Exception{
        ...
        Object[][] testObjArray = ExcelUtils3.getTableArray("C:\\Users\\asokma01\\eclipse-workspace\\selenium-testng-RIN\\src\\test\\resources\\testData\\default.xlsx","Sex");
